...
--
-- Table structure for table `usuario_comunidade`
--
...
--
-- Dumping data for table `usuario_comunidade`
--

LOCK TABLES `usuario_comunidade` WRITE;
/*!40000 ALTER TABLE `usuario_comunidade` DISABLE KEYS */;
/*!40000 ALTER TABLE `usuario_comunidade` ENABLE KEYS */;
UNLOCK TABLES;
